...
import { FolderPlus, Code, Play, Trash2, Edit } from "lucide-react";
...
const HomePage = () => {
  ...
  // ✅ FIXED: This now runs only once when the component mounts
  useEffect(() => {
    const savedUser = localStorage.getItem("cipherstudio-user");
    if (savedUser) {
  ...
  }, []); // runs once, prevents infinite GET requests
        ...
        <div className="hero-section">
          <div className="hero-content">
            <h1 className="hero-title">
              Welcome to <span className="brand">CipherStudio</span>
            </h1>
